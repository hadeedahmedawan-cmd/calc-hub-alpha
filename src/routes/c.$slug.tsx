...
import { CALC_BY_SLUG, slugifyCategory } from "@/lib/calculators/registry";
import { CalculatorPage } from "@/components/CalculatorPage";
import { SITE } from "@/lib/site";

// Retired calculators that were near-duplicates of a more complete tool.
// Redirect instead of 404, so old links and any existing search visibility
// carry over to the replacement rather than dead-ending.
const RETIRED_SLUGS: Record<string, string> = {
  "feet-inches": "length-converter",
  "meters-inches": "length-converter",
};
...
export const Route = createFileRoute("/c/$slug")({
          ...
          : []),
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: c.category, item: `${SITE}/category/${slugifyCategory(c.category)}` },
  ...
  loader: ({ params }) => {
    if (RETIRED_SLUGS[params.slug]) {
      throw redirect({ to: "/c/$slug", params: { slug: RETIRED_SLUGS[params.slug] } });
    }
